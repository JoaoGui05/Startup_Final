...
public class NotificacoesFragment extends Fragment {
    ...
    private NotificacoesAdapter notificacaoAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        listaNotificacoes.add("Funcionário 1 concluiu a ronda.");
        listaNotificacoes.add("Funcionário 2 atrasou o início da ronda.");
        listaNotificacoes.add("Nova atualização disponível no sistema.");

        notificacaoAdapter = new NotificacoesAdapter(listaNotificacoes);
